      ...
      <section className="mx-auto max-w-6xl px-5 py-16 md:px-8">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {projects.slice(0, 4).map((project, idx) => (
            ...
            >
              <div className="h-52 w-full bg-gradient-to-br from-brand-navy/30 via-white to-brand-amber/40 transition duration-500 group-hover:scale-[1.02] dark:from-brand-navy/70 dark:via-[#0b1018] dark:to-brand-amber/30" />
